...
const httpLink = createHttpLink({
  uri: process.env.NODE_ENV === 'development' 
    ? "http://localhost:3001/graphql" // 개발 환경: 직접 백엔드로 요청
    : "/api/graphql", // 프로덕션 환경: 프록시 경로 사용
  // 개발 환경: 직접 localhost:3001로 요청 (Next.js 프록시 우회)
  // 프로덕션 환경: vercel.json의 rewrites가 프로덕션 백엔드로 프록시
            ...
            return new Observable((observer) => {
              ...
              apolloClient
                ...
                .catch((error) => {
                  ...
                  // 리다이렉트는 TokenInitializer에서 처리하므로 여기서는 하지 않음
