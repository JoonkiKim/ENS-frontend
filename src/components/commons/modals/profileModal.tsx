...
import { FETCH_USER, FETCH_LOGIN_USER } from '../../../commons/apis/graphql-queries';
...
export default function ProfileModal({ isOpen, onClose, userId }: ProfileModalProps) {
  ...
  // 기간 계산 함수
  const calculatePeriod = (startDate: string | null, endDate: string | null, isCurrent: boolean): string => {
    if (!startDate) return '';
                ...
                <>
                  ...
                  <ContactHighlightWrapper>
                    ...
                    <HighlightSection>
                      ...
                      <HighlightCard>
                        {getCurrentCareer() && (
                          <HighlightCompany>{getCurrentCareer()?.company}</HighlightCompany>
                        )}
                        <HighlightBadges>
                    ...
                    user.careers.map((career) => (
                      <CareerItem key={career.id}>
                        ...
                        <CareerHeader>
                          ...
                          {career.industry && (
                            <CareerIndustryBadge>{career.industry.name}</CareerIndustryBadge>
                          )}
                        </CareerHeader>
                        <CareerDetails>
                          <CareerRow>
                            ...
                            <CareerPeriod>
                              {calculatePeriod(career.startDate, career.endDate, career.isCurrent)}
                            </CareerPeriod>
                          </CareerRow>
                        </CareerDetails>
                      </CareerItem>
